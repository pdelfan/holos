export default function PackCardSkeleton() {
  return (
    <article className="flex flex-col grow-1 rounded-2xl border border-1 border-slate-200 bg-white hover:border-slate-30 max-[400px]:max-w-[28rem] animate-pulse dark:bg-neutral-600 dark:border-neutral-500">
      <div className="p-5">
