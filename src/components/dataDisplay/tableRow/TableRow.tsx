...
function TableRow(props: Props) {
  ...
  return (
    <>
      <tr
        className={`bg-table-row border-b-2 align-middle dark:bg-neutral-800 dark:border-neutral-700`}
        ref={setNodeRef}
        style={style}
      >
        {!viewMode && (
        ...
        <td className="py-1.5 sm:py-2">
          {image && (
            <Image
              className="border p-1 rounded-lg mx-auto w-[3rem] h-[3.2rem] object-contain dark:border-neutral-400 bg-white"
              src={image}
              alt="Item image"
              height={40}
              width={40}
