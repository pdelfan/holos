...
export default function NotFound() {
  return (
    <main className="flex flex-col items-center justify-center p-3 h-screen">
      ...
      <h1 className="text-header-1 text-center text-4xl sm:text-5xl font-medium mt-3 dark:text-neutral-100">
        404
      </h1>
      <h2 className="text-header-2 text-center text-lg sm:text-xl font-medium mt-1 dark:text-neutral-400">
