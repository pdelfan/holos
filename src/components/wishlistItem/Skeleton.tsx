function Skeleton() {
  return (
    <article className="flex flex-col grow basis-[15rem] sm:max-w-[22rem] rounded-2xl border border-1 border-slate-200 bg-white shadow-sm hover:border-slate-30  hover:drop-shadow-sm max-[400px]:max-w-[30rem] animate-pulse animate-fade-up">
