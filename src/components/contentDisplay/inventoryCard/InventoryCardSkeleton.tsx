export default function InventoryCardSkeleton() {
  return (
    <article className="flex flex-col grow basis-[15rem] sm:max-w-[20rem] rounded-2xl border border-1 border-slate-200 bg-white hover:border-slate-30 max-[400px]:max-w-[30rem] animate-pulse">
